...
<div id="wrapper">
  <header id="header" role="banner">
    ...
    <?php
    /* RRO * 1-10-2012 *
     * disabled display of site_name
     * Do not disable site_name in theme_settings
     * Original line: 
     *  <h1 id="site-title"><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>"><?php print $site_name; ?></a></h1>
     */
    ?>
    <h1 id="site-title"><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>"></a></h1>
    <div id="site-description"><?php print $site_slogan; ?></div>
    <div id="site-description-extra"><?php print t('Premier Supplier of the Ophthalmic Industry');?></div>
    <div class="clear"></div>
    <nav id="main-menu"  role="navigation">
      ...
      <?php
      /* RRO * 9-06-2014 *
       * added contact menu as seperate part of the main menu to be able to float the entries of this menu to the right.
       */
      ?>
      <div class="menu-contact-container">
        <?php 
        if (module_exists('i18n')) {
          $contact_menu_tree = i18n_menu_translated_tree(variable_get('menu_main_links_source', 'menu-contact-menu'));
        } else {
          $contact_menu_tree = menu_tree(variable_get('menu_main_links_source', 'menu-contact-menu'));
        }
        print drupal_render($contact_menu_tree);
        ?>
      </div>
      <div class="clear"></div>
    </nav><!-- end main-menu -->
  ...
  ?>
      ...
      <li>
        ...
        <div class="entry-container">
          ...
          <div class="clear"></div>
            ...
            <img src="<?php print base_path() . drupal_get_path('theme', 'lvo') . '/images/slide-image-1.jpg'; ?>" class="slide-image" /></a>
         <div class="clear"></div>
        </article>
      </li>
      ...
      <li>
        ...
        <div class="entry-container">
          ...
          <div class="clear"></div>
            ...
            <img src="<?php print base_path() . drupal_get_path('theme', 'lvo') . '/images/slide-image-2.jpg'; ?>" class="slide-image" /></a>
         <div class="clear"></div>
        </article>
      </li>
      ...
      <li>
        ...
        <div class="entry-container">
          ...
          <div class="clear"></div>
            ...
            <img src="<?php print base_path() . drupal_get_path('theme', 'lvo') . '/images/slide-image-3.jpg'; ?>" class="slide-image" /></a>
         <div class="clear"></div>
        </article>
      </li>
    </ul>
   ...
   <?php endif; ?>
    ...
    <div id="content">
      <?php if (theme_get_setting('breadcrumbs', 'lvo')): ?><div id="breadcrumbs"><?php if ($breadcrumb): print $breadcrumb; endif;?></div><?php endif; ?>
  ...
  <div id="footer">
     ...
     */
    ?>
    <p class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <?php print $site_name . t('. All rights reserved. Options and accessories may be shown. Information subject to change without notice.'); ?> </p>
    <div class="clear"></div>
    </div>
  </div>
</div>
